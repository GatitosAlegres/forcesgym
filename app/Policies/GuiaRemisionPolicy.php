...
class GuiaRemisionPolicy
{
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function view(User $user, GuiaRemision $guiaRemision): bool
    {
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function update(User $user, GuiaRemision $guiaRemision): bool
    {
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function delete(User $user, GuiaRemision $guiaRemision): bool
    {
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function forceDelete(User $user, GuiaRemision $guiaRemision): bool
    {
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function restore(User $user, GuiaRemision $guiaRemision): bool
    {
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function replicate(User $user, GuiaRemision $guiaRemision): bool
    {
