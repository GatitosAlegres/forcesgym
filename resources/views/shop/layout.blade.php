                    ...
                    <div class="relative inline-block text-left">
                        <div>
                            <button type="button"
                                ...
                                <span
                                    class="whitespace-nowrap rounded-full bg-green-100 px-2.5 py-0.5 text-sm text-green-950">
                                        ...
                                        @if (session('cart'))
                                            @foreach (session('cart') as $id => $details)
                                                <li class="flex items-center gap-4">
                                                    ...
                                                    <div>
                                                        <h3 class="text-sm text-gray-900"> {{ $details['name'] }}
                                                        </h3>

                                                        <dl class="mt-0.5 space-y-px text-[10px] text-gray-600">
                                                            <div>
                                                                <dt class="inline">Precio:</dt>
                                                                <dd class="inline"> {{ $details['price'] }} nuevos
                                                                    soles
                                                                </dd>
                                                            </div>
